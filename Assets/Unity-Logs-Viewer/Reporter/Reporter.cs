...
public class Reporter : MonoBehaviour
{
...
#if HLModify
	// iPhone Xs 처럼 상단을 띄우고 표시할 경우 사용.
	public Vector2 topGapSize = Vector2.zero;
#endif
...
#if HLModify
	public event System.Action<bool> onReporterShow;
#endif
	...
	void drawToolBar()
	{
		...
		Vector2 drag = getDrag();
#if HLModify
		if ((drag.x != 0) && (downPos != Vector2.zero) && (downPos.y > Screen.height - size.y * 2f - topGapSize.y) && downPos.y < Screen.height - topGapSize.y)
		{
#else
	...
	public void OnGUIDraw()
	{
		...
		logsRect.x = 0f;
#if HLModify
		logsRect.y = size.y * 2f + topGapSize.y;
#else
...
#if HLModify
		stackRect.y = Screen.height * 0.75f + topGapSize.y;
#else
